...
// Import services directly to make sure they're available
import { productService, userService, orderService, cartService, categoryService } from './services/api-service';
...
try {
  console.log('Starting ThreeMuffins minimal working application');
