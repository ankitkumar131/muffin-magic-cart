...
const ProductListApiExample: React.FC = () => {
  const {
    data: products,
    loading,
    error,
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold">Products (API Example)</h1>
        <div className="flex items-center">
          <span className="text-sm">Using backend API</span>
        </div>
      </div>
...
export default ProductListApiExample;
